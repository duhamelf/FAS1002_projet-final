...
ggplot(data = life_ghg_gdp_2010) + 
  geom_smooth(mapping = aes(x = ghg_per_capita, y = gdp_per_capita)) +
      geom_point(mapping = aes(x = ghg_per_capita, y = gdp_per_capita))

# graph ghg/life exp good? 

ggplot(data = life_ghg_gdp_2010) + 
  geom_smooth(mapping = aes(y = ghg_per_capita, x = life_exp)) +
      geom_point(mapping = aes(y = ghg_per_capita, x = life_exp))
```
