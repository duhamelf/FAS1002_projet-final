...
#fonctionne! Marche pas pr df1 pcq il y a déjà des continents dans country pê?? extraire autrement 
```
...
```{r}
# df1 <- as_data_frame(X2022_12_07_GHG_emissions)
